    ...
    <section class="fd">
		...
		<div class="login">
			...
			<form action="login.php" method="post">
				...
				<input type="text" name="captcha" placeholder="enter captcha" id="captcha" style="width: 150px; margin-right: 20px;" required>
			...
			Not Registered:- 
			<a href="signup.php" class="hero-btn red-btn reset-btn"  >Sign Up</a><br>
			<a href="forget_pass.php"  style="text-decoration: none; margin-right: 20px;">Forgot Password</a>
				<a style="text-decoration: none;" href="admin login.html">Admin</a>
		</div>
	</section>
